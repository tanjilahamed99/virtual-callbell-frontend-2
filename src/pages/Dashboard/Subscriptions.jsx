          ...
          {sub?.length > 0 ? (
            <>
              {sub?.map((plan, idx) => (
                <div
                  key={idx}
                  className="relative space-y-8 bg-white p-8 shadow-[0px_0px_30px_2px_rgba(100,100,111,0.1)] md:w-[300px] dark:bg-[#18181B]">
                  {/* top part  */}
                  <div>
                    <img
                      width={60}
